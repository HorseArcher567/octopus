...
var file_greeter_proto_rawDesc = []byte{
	...
	0x07, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x22, 0x0e, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c,
	...
	0x61, 0x67, 0x65, 0x32, 0x7c, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x38,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x04, 0x42, 0x69, 0x62, 0x69,
	...
	0x6b, 0x38, 0x73, 0x2d, 0x70, 0x72, 0x61, 0x63, 0x74, 0x69, 0x63, 0x65, 0x2f, 0x6f, 0x63, 0x74,
	0x6f, 0x70, 0x75, 0x73, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x73, 0x69, 0x6d,
	0x70, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x65,
...
var file_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.Bibi:input_type -> greeter.HelloRequest
	1, // 2: greeter.Greeter.Hello:output_type -> greeter.HelloResponse
	1, // 3: greeter.Greeter.Bibi:output_type -> greeter.HelloResponse
...
type GreeterClient interface {
	...
	Bibi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *greeterClient) Bibi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/greeter.Greeter/Bibi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	Bibi(context.Context, *HelloRequest) (*HelloResponse, error)
}
...
func (*UnimplementedGreeterServer) Bibi(context.Context, *HelloRequest) (*HelloResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Bibi not implemented")
}
...
func _Greeter_Bibi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).Bibi(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greeter.Greeter/Bibi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Bibi(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
